        ...
        <div className="contact-page">
            <div className="mx-auto max-w-5xl">
                ...
                <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 rounded-3xl border border-neutral-200 bg-white/80 backdrop-blur-sm px-6 py-8 shadow-sm">
                        <form>
                            <div>
                    ...
                    <div className="rounded-3xl border border-neutral-200 bg-white/80 backdrop-blur-sm px-6 py-8 shadow-sm">
                        ...
                        <div className="mt-4 space-y-3 text-neutral-700">
                            ...
                            <div>
                                <a
                                    className="inline-flex items-center justify-center rounded-md border border-neutral-300 bg-white px-4 py-2 text-sm font-semibold text-neutral-900 hover:bg-neutral-50"
                                    href={mapsHref}
                                    target="_blank"
                                    rel="noreferrer"
                                >
